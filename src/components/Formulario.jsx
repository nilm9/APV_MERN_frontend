    ...
    <>
        ...
        <form onSubmit={handleSubmit} className='bg-white py-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md'>
            ...
            <div className="mb-5">
                ...
                <input type="email" id='email' placeholder='Nombre del propietario' className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' value={email} onChange={e=>setEmail(e.target.value)}/>
            </div>
            <div className="mb-5">
                <label htmlFor="fecha" className='text-gray-700 uppercase font-bold'> Fecha alta </label>
                <input type="date" id='fecha' className='border-2 w-full p-2 mt-2' value={fecha} onChange={e=>setFecha(e.target.value)} />
            </div>
            <div className="mb-5">
                <label htmlFor="sintomas" className='text-gray-700 uppercase font-bold'> Sintomas </label>
                <input type="textarea" id='sintomas' placeholder='Describe los sintomas' className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' value={sintomas} onChange={e=>setSintomas(e.target.value)} />
            </div>
